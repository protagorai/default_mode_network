...
from ..neurons.base_neuron import BaseNeuron, NeuronFactory, NeuronType, NeuronParameters
from ..neurons.synapse import SynapseFactory, SynapticParameters, SynapseType
...
class NetworkBuilder:
    ...
    def _create_neurons(self, config: NetworkConfiguration) -> Dict[str, BaseNeuron]:
        ...
        if config.neuron_type == NeuronType.LEAKY_INTEGRATE_FIRE:
            from ..neurons.lif_neuron import LIFParameters
